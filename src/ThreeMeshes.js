...
import * as THREE from '../vendor/three.js-r117/build/three.module.js'
...
export class QuadSpritesMesh extends BaseMesh {
    ...
    update(turtles, viewFcn) {
        ...
        this.mesh.geometry.setAttribute('position', new THREE.BufferAttribute(new Float32Array(positions), 3))
        this.mesh.geometry.setAttribute('uv', new THREE.BufferAttribute(new Float32Array(uvs), 2))
        this.mesh.geometry.setIndex(new THREE.BufferAttribute(new Uint32Array(indexes), 1))
    }
}
